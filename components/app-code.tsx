    ...
    <PageShell>
      ...
      <Section>
        <div className="mx-auto max-w-md text-center">
          {token ? (
            <>
              <p className="text-sm font-bold text-ink-soft uppercase tracking-wide">Your code</p>
              <p className="mt-2 rounded-xl2 bg-white/70 px-4 py-5 font-mono text-2xl font-bold tracking-widest text-ink ring-1 ring-sand break-all">
                {token}
              </p>
              <a href={deepLink} className="mt-6 inline-block rounded-full bg-amber px-6 py-3 font-extrabold text-white hover:bg-amber-deep">
                Open in Talepuff
              </a>
